...
export function showEditCustomsCategoryModal(category) {
      ...
      <div id="modalContent" class="card-bg rounded-lg shadow-lg w-full max-w-md mx-4 p-6 max-h-[90vh] overflow-y-auto">
        ...
        <div class="mb-6">
          ...
          <input
            type="number"
            id="duty-rate"
            value="${formatPercent(category.dutyRate)}"
            step="0.01"
            min="0"
            max="100"
            class="w-full px-4 py-3 border border-default input-bg card-text rounded-lg focus:outline-none focus:ring-2 focus:ring-primary"
        ...
        <div class="mb-6">
          ...
          <input
            type="number"
            id="vat-rate"
            value="${formatPercent(category.vatRate)}"
            step="0.01"
            min="0"
            max="100"
            class="w-full px-4 py-3 border border-default input-bg card-text rounded-lg focus:outline-none focus:ring-2 focus:ring-primary"
  ...
  const save = () => {
    ...
    actions.updateCustomsCategory(category.id, updatedCategory, defaultVAT).then(() => {
      closeModal()
    })
  }
